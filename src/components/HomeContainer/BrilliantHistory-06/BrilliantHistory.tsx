  ...
  return (
    <section className="relative  my-20  w-[100%] flex flex-col md:flex-row items-center justify-between">
      ...
      >
        ...
        />
        <div className=" h-9 w-32 mr-14">
          <ChipText ChipText={" آلفا درخشان  "} />
        </div>
        <h2 className="text-2xl  mr-14 font-bold dark:text-white  text-[#444] my-6">
          <span className="text-indigo-500 font-extrabold  text-3xl">10+</span>{" "}
          سال سابقه درخشان
        </h2>
        <p className="text-gray-600 w-[664px]  h-[266px] ml-[820px] text-base mr-14 dark:text-white leading-loose">
          ...
          از صنعت چاپ و با استفاده از طراحان گرافیک است...لورم ایپسوم متن ساختگی
