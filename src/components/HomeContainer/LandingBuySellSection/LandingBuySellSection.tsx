  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <MyChip size="lg" className="bg-transparent px-3 py-6 border border-[#7575FE] !font-black text-[#7575FE]">
          خرید و فروش
        </MyChip>
        <div className="flex items-center gap-2">
          ...
          <ClientButton size="lg" className="inline-flex bg-[#7575FE] mr-auto py-6 text-white">مشاهده همه</ClientButton>
        </div>          
      </div>
