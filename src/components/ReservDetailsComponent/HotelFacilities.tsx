...
const facilities = [
  ...
  { id: 7, name: "سرمایش", ansver: "کولر" },
  { id: 8, name: "بالکن ", ansver: "دارد" },
  { id: 9, name: "اجاق گاز ", ansver: "دارد" },
  { id: 10, name: "پارکینگ", ansver: "دارد" },
  { id: 11, name: "اسانسور", ansver: "دارد" },
  { id: 12, name: "حمام", ansver: "دارد" },
  { id: 13, name: "نوع نما ", ansver: "رومی" },
  { id: 14, name: "سن بنا ", ansver: "نوساز" },
  { id: 15, name: "اپن", ansver: "سنگی" },
  { id: 16, name: "خط تلفن", ansver: "دارد" },
];

const HotelFacilities = () => {
  return (
    <div className="space-y-4 p-8 pr-0">
      <ChipText ChipText={"امکانات هتل"} />
        ...
        {facilities.map((facility) => (
          <div key={facility.id} className="flex  gap-4 p-2 pr-3  border-r-1">
            ...
            <div>
              ...
              <p className="text-gray-700">{facility.ansver}</p>
            </div>
          </div>
        ))}
      </div>
