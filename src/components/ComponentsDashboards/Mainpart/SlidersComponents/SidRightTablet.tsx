  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between h-full items-center">
                ...
                >
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="dark:bg-accent bg-gray-200 dark:bg-gray-800 dark:accent-foreground absolute right-6 whitespace-nowrap text-foreground">
                        <p> {label} </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
        ...
        <Link
          className="hover:bg-gray-200 dark:bg-gray-800 px-3 py-2 flex justify-center items-center rounded-lg"
          href={""}
        >
          <TooltipProvider>
            <Tooltip>
