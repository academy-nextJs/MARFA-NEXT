    ...
    <form className="flex w-full max-xl:flex-col flex-row max-xl:gap-8">
      <div className="flex flex-col gap-2 w-1/2 max-xl:w-full">
        ...
        <div className="flex gap-4">
          <Button
            type="button"
            className="bg-gray-200 dark:bg-gray-800 w-fit rounded-2xl mt-[10px]"
            variant={"scale"}
          >
            {" "}
            انصراف{" "}
          ...
          <Button
            type="submit"
            className="bg-primary w-fit text-primary-foreground rounded-2xl mt-[10px]"
            variant={"scale"}
          >
            {" "}
            اعمال تغییرات{" "}
      ...
      <div className="w-1/2 max-xl:w-full flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <Label htmlFor="perviousPassword" className="text-subText">
            {" "}
            رمز عبور قبلی :{" "}
          </Label>
          <Input
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="newPassword" className="text-subText">
            {" "}
            رمز عبور جدید :{" "}
          </Label>
          <Input
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="repeatPassword" className="text-subText">
            {" "}
            تکرار رمز عبور :{" "}
          </Label>
          <Input
