...
const FinincialManagement = () => {
  return (
    <div
      delay={1}
      className="w-full min-h-full rounded-[12px] bg-[#ffffff] dark:bg-gray-800 flex gap-4 px-4 py-4 flex-col"
    >
      <div className="flex justify-between w-full items-center flex-wrap gap-4">
        <div className="flex gap-2 w-fit items-center">
          <Pin size={24} />
          <span className="text-base font-bold"> لیست تراکنش های مشتریان </span>
        </div>
        <Link
      ...
      <Table className="text-right max-lg:hidden overflow-hidden w-full">
        <TableHeader className="bg-gray-200 dark:bg-gray-800 rounded-t-2xl text-foreground">
            ...
            <TableRow key={idx}>
              ...
              <TableCell>
                ...
                >
                  ...
                  {reserve.status ? " تایید شده " : " تایید نشده "}{" "}
                </div>
              </TableCell>
            </TableRow>
          ))}
      ...
      <div className="flex flex-col gap-4 w-full lg:hidden">
        {reserves.map((reserve, idx) => (
          <div
            key={idx}
            className="w-full max-sm:flex-col bg-gray-200 dark:bg-gray-800 px-4 py-4 rounded-xl flex gap-4"
          >
            <img
              src={reserve.image || "  "}
              alt=" "
            ...
            <div className=" h-full flex flex-col gap-2 max-sm:gap-4 text-base">
              <div className="flex gap-4 items-center flex-wrap">
                ...
                <p className="text-subText"> نام اقامتگاه : </p>{" "}
              ...
              <div className="flex gap-4 items-center flex-wrap">
                ...
                <p className="text-subText"> قیمت : </p>{" "}
                <span className="gap-2 flex">
                  {" "}
                  {SplitNumber(reserve.price)} <p>تومن </p>{" "}
                </span>{" "}
              </div>
              <div className="flex gap-4 items-center flex-wrap">
                {" "}
...
export default FinincialManagement;
