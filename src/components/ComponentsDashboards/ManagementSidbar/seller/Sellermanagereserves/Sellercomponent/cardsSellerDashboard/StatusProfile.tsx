...
const EditLink = () => (
  <Link href="/dashboard/seller/profile" className='w-fit cursor-pointer flex items-center gap-2'>
...
const StatusProfile = () => {
  return (
    <div delay={0.70} className='w-1/2 max-lg:w-full min-h-full rounded-[12px] bg-subBg flex flex-col gap-4 px-4 py-4'>
      {/* Header */}
      ...
      {/* Divider */}
      <div className="w-full border-t border-dashed border-[#88888842]"></div>
