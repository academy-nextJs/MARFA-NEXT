    ...
    <div className="flex flex-col gap-8">
      <Table className="text-right max-lg:hidden overflow-hidden w-full">
        ...
        <TableBody>
          <TableRow
            ...
            className="cursor-pointer bg-[#ffffff] dark:bg-gray-800"
          >
            <TableCell
              colSpan={3}
          ...
          {openUnread &&
            unread.map((not, idx) => (
              <TableRow
                key={idx}
                className="hover:bg-gray-200 dark:bg-gray-800 relative"
              >
          ...
          {openRead &&
            read.map((not, idx) => (
              <TableRow
                key={idx}
                className="hover:bg-gray-200 dark:bg-gray-800 opacity-70"
              >
      ...
      <div className="flex flex-col gap-4 lg:hidden">
        <div className="space-y-2">
          <div
            onClick={() => setOpenUnread((v) => !v)}
            className="flex justify-between items-center bg-gray-200 dark:bg-gray-800 px-4 py-2 rounded-lg cursor-pointer"
          >
          ...
          {openUnread &&
            unread.map((not, i) => (
              <div
                key={i}
                className="bg-gray-200 dark:bg-gray-800 p-4 rounded-lg space-y-2"
              >
        ...
        <div className="space-y-2">
          ...
          {openRead &&
            read.map((not, i) => (
              <div
                key={i}
                className="bg-gray-200 dark:bg-gray-800 p-4 rounded-lg opacity-70 space-y-2"
              >
