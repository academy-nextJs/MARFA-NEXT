  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent
        ...
        className="rounded-2xl max-w-[800px] flex flex-col gap-8 items-center"
      >
        <DialogHeader className="flex justify-between flex-row w-full items-center my-4">
          <DialogTitle className="text-xl">لیست مسافر ها</DialogTitle>
          <DialogDescription>
            <CommonButton
