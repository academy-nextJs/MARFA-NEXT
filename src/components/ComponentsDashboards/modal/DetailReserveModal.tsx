  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        ...
        className="rounded-2xl py-8 px-6 w-full max-w-[1050px]"
      >
        <DialogTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-4 justify-between">
              <img
                src={"  "}
                alt="تصویر"
                className="w-full max-md:h-[150px] h-[300px] bg-muted rounded-xl flex items-center justify-center text-muted-foreground"
              />
              <div className="flex flex-col gap-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-2 truncate">
                  <MapPin size={16} /> کیش، گیلان، رشت، چابکسر، جاده رشت...
                </div>
              ...
              <div className="bg-gray-200 dark:bg-gray-800 px-4 py-2 rounded-xl flex justify-between gap-4 flex-wrap">
            ...
            <div className="flex flex-col gap-4 text-right">
              ...
              <div className="text-xs flex gap-2 text-muted-foreground">
                <Calendar size={16} />
                تاریخ رزرو:{" "}
                <span className="font-semibold">12 مرداد - 1401 / 12:33</span>
              </div>
