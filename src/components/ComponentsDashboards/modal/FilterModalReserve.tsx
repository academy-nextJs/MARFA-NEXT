...
import DatePickerInput from '@/components/common/inputs/common/DatePickerInput'
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen} >
            <DialogTrigger asChild>
                <div className='cursor-pointer px-4 py-2 p-2  rounded-[14px] h-fit flex text-primary-foreground max-md:w-full justify-center bg-primary text-sm hover:scale-[1.02] transition-all'>
                    فیلترها
                </div>
            </DialogTrigger>
